...
<figure id="fig:encounter-xp-thresholds-vs-level">
    {% include_relative xp-and-player-characters/fig-encounter-xp-thresholds-vs-level.html %}
...
<figure id="fig:encounter-xp-vs-level-medium-adventuring-days">
    {% include_relative xp-and-player-characters/fig-half-daily-xp-vs-level-medium-adventuring-days.html %}
...
<figure id="fig:daily-xp-vs-level-medium-adventuring-days">
    {% include_relative xp-and-player-characters/fig-full-daily-xp-vs-level-medium-adventuring-days.html %}
...
<figure id="fig:pcs-encounter-xp-vs-level-Medium-adventuring-days">
    {% include_relative xp-and-player-characters/fig-pcs-encounter-xp-vs-level-medium-adventuring-days.html %}
...
<figure id="fig:pcs-encounter-ehp-vs-level-medium-adventuring-days">
    {% include_relative xp-and-player-characters/fig-pcs-encounter-ehp-vs-level-medium-adventuring-days.html %}
...
<figure id="fig:pcs-encounter-edpr-vs-level-medium-adventuring-days">
    {% include_relative xp-and-player-characters/fig-pcs-encounter-edpr-vs-level-medium-adventuring-days.html %}
